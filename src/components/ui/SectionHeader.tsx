...
const SectionHeader: React.FC<SectionHeaderProps> = ({
  ...
  return (
    <div className={`${isCenter ? 'text-center' : 'text-left'} ${className}`}>
      <p className="text-[14px] font-medium tracking-[0.05em] text-[#2F7A3A] uppercase md:text-[18px] xl:text-[24px]">
        {label}
      </p>
      ...
      <p 
        className={`mt-6.25 max-w-6xl text-[16.5px] font-medium leading-snug text-[#5F6878] md:text-[22px] xl:text-[30px] ${
